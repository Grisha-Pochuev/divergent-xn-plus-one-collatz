...
def check() -> None:
    ...
    for relative in NO_EXCEPTIONAL_MEMORY_FILES:
        require_text(relative, (str(NO_EXCEPTIONAL_MIN_BLOCKS),))

    for relative in NO_EXCEPTIONAL_CF_FILES:
        require_text(relative, (str(NO_EXCEPTIONAL_CF_DENOMINATOR),))
