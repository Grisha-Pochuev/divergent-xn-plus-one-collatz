...
def main() -> None:
    ...
    max_credit = 4500
    max_exceptional_excess = 4499
    max_complete_blocks = 4500
    assert max_credit < q9
    assert max_exceptional_excess + 1 == max_complete_blocks
    ...
    print("minimum-boundary actual expanding segment verified")
    print(f"maximum net credit={max_credit}")
    print(f"maximum exceptional excess={max_exceptional_excess}")
    print(f"maximum complete blocks={max_complete_blocks}")
    print("continued-fraction natural-log gap exceeds 2^-4023")
    print("segment correction is below 2^-4023")
    print("the actual minimum-boundary segment has L*delta<C and grows")
