...
def main() -> None:
    ...
    run("tools/verify_global_divisor_ordinary_population.py")
    ...
    run("tools/verify_primary_one_over_1007_cycle_strip.py")
    run("tools/verify_primary_credit_continued_fraction_frontier.py")
